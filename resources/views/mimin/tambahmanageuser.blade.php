    ...
    <div class="box1" style="margin-top: 20px;">
        ...
        <form action="{{route('user.store')}}" method="POST">
            ...
            <div class="px-4 py-5 space-y-4 sm:p-6">
                ...
                <div>
                    <input type="text" class="flex-1 block w-full form" name="name" id="name" placeholder="Masukan Nama" value="{{old('name')}}">
                </div>
                <label class="block text-sm text-lg">Username</label>
                <div>
                    <input type="text" class="flex-1 block w-full form" name="username" id="username" placeholder="Masukan Username" value="{{old('username')}}">
                </div>
                ...
                <div>
                    <input type="email" class="flex-1 block w-full form" name="email" id="email" placeholder="Masukan Email" value="{{old('email')}}">
                </div>
